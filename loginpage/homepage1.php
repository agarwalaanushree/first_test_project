                ...
                <div class="card-single">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <?php
                            $sql = "select count(bookid) as isBook from record where Date_of_Issue!='0000-00-00' and Dues=0";
                            $res = $con->query($sql);
                ...
                <div class="card-single">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <?php
                            $sql2 = "select count(bookid) as isReturn from record where  Date_of_Return != '0000-00-00'";
                            $res2 = $con->query($sql2);
                ...
                <div class="card-single">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <?php
                            $sql1 = "select count(bookid) as notReturn from record where Date_of_Issue!='0000-00-00' and Date_of_Return IS  NULL";
                            $res1 = $con->query($sql1);
