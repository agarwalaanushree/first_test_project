        ...
        <main>
            <div class="">
                ...
                <table class="content-table" id="tables">
                    ...
                    <tbody>
                        <?php
                        $sql = "select * from record,books where Date_of_Issue is NULL and record.bookid=books.bookid order by Time";
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <?php
                                        if ($sts > 0) {
                                            echo "<a href=\"accept_issue.php?id1=" . $bookid . "&id2=" . $enroll . "\" class=\"btn-primary1\">Accept</a>";
                                        }
                                        ?>
                                        <a href="reject_issue.php?id1=<?php echo $bookid ?>&id2=<?php echo $enroll ?>" class="btn-primary1">Reject</a>
                                    </center>
                                </td>
                            </tr>
                        <?php } ?>
